...
class SqlitePostRepositoryTest extends TestCase
{
    public function testItReturnsValuesAsString(): void
    {
        ...
        $repository = new SqlitePostsRepository($connectionStub, $logger);
        $repository->save(
            new Post(
                new UUID('140e8659-c69f-4a7e-a7dc-88b85432ae7b'),
                new User(new UUID('140e8659-c69f-4a7e-a7dc-88b85432ae7b'), 'moiseev.albina', 'some_password', 'Ульяна', 'Шилова'),
                'Exercitationem.',
